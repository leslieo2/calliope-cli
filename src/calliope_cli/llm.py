...
from calliope_cli.constant import USER_AGENT

if TYPE_CHECKING:
    from calliope_cli.config import LLMModel, LLMProvider
...
def create_llm(
    ...
    *,
    ...
    match provider.type:
        ...
        case "deepseek":
            # DeepSeek currently supports OpenAI-compatible /chat/completions.
            # Use the legacy OpenAI client instead of the new /responses endpoint.
            from kosong.contrib.chat_provider.openai_legacy import OpenAILegacy
